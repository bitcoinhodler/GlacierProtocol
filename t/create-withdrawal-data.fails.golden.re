...
How many private keys will you be signing this transaction with (at least 2 required to complete transaction)?
#: Key #1: Key #2: 
Enter fee rate.
Satoshis per vbyte: Output from subprocess: error code: -5
error message:
Invalid Bitcoin address: myP4xdJNwAW9iMakvCjnozg814ewgn8apx

Traceback (most recent call last):
  File "<.*>.py", line <.*> in checkoutput
    raise subprocess.CalledProcessError(retcode, cmd_list, output=output)
subprocess.CalledProcessError: Command '['bitcoin-cli', '-regtest', '-rpcport=<\d+>', '-datadir=../bitcoin-data/<\d+>', 'createrawtransaction', '[{"txid": "e0e9bb25fb873c4caccdc8ab743c4350310031f2cc077bb90c3f495458860157", "vout": 1, "amount": "0.10000000", "scriptPubKey": "a914ad50fb2489353008e75b0193011ff1f4b76f798c87", "redeemScript": ""}]', '{"2N93du8YobdgsHyu3qgBvSyhGUT52utMNeA": 0, "myP4xdJNwAW9iMakvCjnozg814ewgn8apx": 0}', '0', 'false']' returned non-zero exit status 5<\.?>
